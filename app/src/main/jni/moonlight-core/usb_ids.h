...
#define USB_PRODUCT_NINTENDO_SWITCH_PRO_2                 0x2069
#define USB_PRODUCT_NINTENDO_SWITCH_JOYCON_LEFT_2         0x2066
#define USB_PRODUCT_NINTENDO_SWITCH_JOYCON_RIGHT_2        0x2067
