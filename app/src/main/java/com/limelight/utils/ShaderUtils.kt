...
object ShaderUtils {
    ...
    const val FRAGMENT_SHADER_3D = "#extension GL_OES_EGL_image_external : require\n" +
    ...
    const val OPTIMIZED_SINGLE_PASS_GAUSSIAN_BLUR_SHADER = "precision mediump float;\n" +
            "varying vec2 v_TexCoord;\n" +
    ...
    const val SIMPLE_VERTEX_SHADER = "attribute vec4 a_Position;\n" +
            "attribute vec2 a_TexCoord;\n" +
            "varying vec2 v_TexCoord;\n" +
            "void main() {\n" +
            "    gl_Position = a_Position;\n" +
    ...
    const val EDGE_AWARE_VERTEX_SHADER = "attribute vec4 a_Position;\n" +
            "attribute vec2 a_TexCoord;\n" +
            "varying vec2 v_TexCoord;\n" +
            "void main(){\n" +
            "  v_TexCoord = a_TexCoord;\n" +
    ...
    const val EDGE_AWARE_DEPTH_BLUR_SHADER = "precision mediump float;\n" +
            "varying vec2 v_TexCoord;\n" +
    ...
    const val SIMPLE_FRAGMENT_SHADER = "#extension GL_OES_EGL_image_external : require\n" +
            "precision mediump float;\n" +
            "varying vec2 v_TexCoord;\n" +
